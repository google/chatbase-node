...
class MessageStateWrapper extends MessageStateSink {
  ...
  _handleCreateError (error, reject) {
    ...
    logger(error);
    super.setAsCreateErrored(error);
  ...
  _handleUpdateError (error, reject) {
    ...
    logger(error);
    super.setAsUpdateErrored(error);
    return reject(error.error);
  }
  /**
    ...
    return new Promise((resolve, reject) => {
      ...
      Transport.sendMessage(payload)
        .then(response => {
          ...
          super.setAsCreateCompleted(response.body);
          return resolve(this);
        })
  ...
  update () {
    return new Promise((resolve, reject) => {
      ...
      super.setAsUpdateStarted();
      const opts = super.optionsManifest();
      Transport.sendUpdate(query, pickBy(payload, (v, key) => opts[key]))
        .then(response => {
          ...
          super.setAsUpdateCompleted(response.body);
          return resolve(this);
        })
