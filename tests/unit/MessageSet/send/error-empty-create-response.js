...
test('Receiving a 200-OK without body', async t => {
  ...
  t.true(error instanceof errors.EmptyCreateResponse,
    'The error should be an instance of the EmptyCreateResponse class');
  scope.done();
});
